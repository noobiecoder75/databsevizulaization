...
function App() {
  const [activeTab, setActiveTab] = useState<'overview' | 'slideshow-refactored' | 'tier2-slideshow' | 'visualizations' | 'trade-viz' | 'vendor-trade'>('overview');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <nav className="flex space-x-8 overflow-x-auto">
            ...
            >
              BC Hydro Supply Chain Analysis
            </button>
            <button
            ...
            >
              International Equipment Analysis
            </button>
            <button
        ...
        {/* Vendor Supply Chain Insights - Only show on homepage */}
        {activeTab === 'overview' && (
